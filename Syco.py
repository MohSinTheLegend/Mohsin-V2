...
def saving():
    titik = [".   ","..  ","... "]
    for o in titik:
        print(" Saving Token By Mohsin "+o),;sys.stdout.flush();time.sleep(0.5)
def updateing():
    titik = [".   ","..  ","... "]
    for o in titik:
...
def clone_loginvia():
    ...
    if hack =="1":
        ...
        os.system('clear')
        print logo
        print ("Login With Token").center(70)
        print u"\u001b[1;46m---------------------------------------------"
        ...
        time.sleep(0.5)
        os.system("clear")
        print("Token Save By Mohsin").center(70)
        time.sleep(4)
...
def loginfb():
    ...
    os.system('clear')
    print logo
    print("\033[34;1mFacebook \033[1;97mLogin").center(70)
    print u"\u001b[1;46m---------------------------------------------"
    ...
    if "access_token" in q:
        ...
        if "www.facebook.com" in q["error_msg"]:
            ...
            print("\n\033[1;31m[!] Login Email/ID/Number OR Password Wrong")
            time.sleep(0.5)
            loginfb()
...
def menu():
    ...
    print(" Name : ")
    print u"\u001b[1;46m---------------------------------------------"
    print("[1] HACK FROM FRIEND LIST AND Public ID")
    print("[0] logout")
    print u"\u001b[1;46m---------------------------------------------"
    menu_select()
def menu_select():
...
def crack():
        ...
        print ("[2] Hack From \033[1;92mID\033[1;97m Public")
        print ('[0] Back')
        print u"\u001b[1;46m---------------------------------------------"
        crack2()
def crack2():
        ...
        print(' Home \033[1;92mSuccessful\033[1;90m/\033[1;93mCheckpoint:  '+str(len(cps))+'/\033[;32m '+str(len(oks)))
        print u"\u001b[1;46m---------------------------------------------"
        down()
def down():
    dow = raw_input("[?] Saved File Checkpoint OK ? (Y/N) ")
    if dow =="yes" or dow =="y":
        os.system("clear")
        print logo
        download()
